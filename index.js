...
user_1.login("TOKEN AQUI").catch(() => {
	console.log("user_1 inoperante");
	return;
});
user_2.login("TOKEN AQUI").catch(() => {
	console.log("user_2 inoperante!");
	return;
});
user_3.login("TOKEN AQUI").catch(() => {
	console.log("user_3 inoperante!");
	return;
});
user_4.login("TOKEN AQUI").catch(() => {
	console.log("user_4 inoperante!");
	return;
});
user_5.login("TOKEN AQUI").catch(() => {
	console.log("user_5 inoperante!");
	return;
});
user_6.login("TOKEN AQUI").catch(() => {
	console.log("user_6 inoperante!");
	return;
});
user_7.login("TOKEN AQUI").catch(() => {
	console.log("user_7 inoperante!");
	return;
});
user_8.login("TOKEN AQUI").catch(() => {
	console.log("user_8 inoperante!");
	return;
});
user_9.login("TOKEN AQUI").catch(() => {
	console.log("user_9 inoperante!");
	return;
});
user_10.login("TOKEN AQUI").catch(() => {
	console.log("user_10 inoperante!");
	return;
});
user_11.login("TOKEN AQUI").catch(() => {
	console.log("user_11 inoperante!");
	return;
});
user_12.login("TOKEN AQUI").catch(() => {
	console.log("user_12 inoperante!");
	return;
});
user_13.login("TOKEN AQUI").catch(() => {
	console.log("user_13 inoperante!");
	return;
});
user_14.login("TOKEN AQUI").catch(() => {
	console.log("user_14 inoperante!");
	return;
});
user_15.login("TOKEN AQUI").catch(() => {
	console.log("user_15 inoperante!");
	return;
});
user_16.login("TOKEN AQUI").catch(() => {
	console.log("user_16 inoperante!");
	return;
});
user_17.login("TOKEN AQUI").catch(() => {
	console.log("user_17 inoperante!");
	return;
});
user_18.login("TOKEN AQUI").catch(() => {
	console.log("user_18 inoperante!");
	return;
});
user_19.login("TOKEN AQUI").catch(() => {
	console.log("user_19 inoperante!");
	return;
});
user_20.login("TOKEN AQUI").catch(() => {
	console.log("user_20 inoperante!");
	return;
});
user_21.login("TOKEN AQUI").catch(() => {
	console.log("user_21 inoperante!");
	return;
});
user_22.login("TOKEN AQUI").catch(() => {
	console.log("user_22 inoperante!");
	return;
});
user_23.login("TOKEN AQUI").catch(() => {
	console.log("user_23 inoperante!");
	return;
});
user_24.login("TOKEN AQUI").catch(() => {
	console.log("user_24 inoperante!");
	return;
});
user_25.login("TOKEN AQUI").catch(() => {
	console.log("user_25 inoperante!");
	return;
});
user_26.login("TOKEN AQUI").catch(() => {
	console.log("user_26 inoperante!");
	return;
});
user_27.login("TOKEN AQUI").catch(() => {
	console.log("user_27 inoperante!");
	return;
});
user_28.login("TOKEN AQUI").catch(() => {
	console.log("user_28 inoperante!");
	return;
});
user_29.login("TOKEN AQUI").catch(() => {
	console.log("user_29 inoperante!");
	return;
});
user_30.login("TOKEN AQUI").catch(() => {
	console.log("user_30 inoperante!");
	return;
});
user_31.login("TOKEN AQUI").catch(() => {
	console.log("user_31 inoperante!");
	return;
});
user_32.login("TOKEN AQUI").catch(() => {
	console.log("user_32 inoperante!");
	return;
});
user_33.login("TOKEN AQUI").catch(() => {
	console.log("user_33 inoperante!");
	return;
});
user_34.login("TOKEN AQUI").catch(() => {
	console.log("user_34 inoperante!");
	return;
});
user_35.login("TOKEN AQUI").catch(() => {
	console.log("user_35 inoperante!");
	return;
});
user_36.login("TOKEN AQUI").catch(() => {
	console.log("user_36 inoperante!");
	return;
});
user_37.login("TOKEN AQUI").catch(() => {
	console.log("user_37 inoperante!");
	return;
});
user_38.login("TOKEN AQUI").catch(() => {
	console.log("user_38 inoperante!");
	return;
});
user_39.login("TOKEN AQUI").catch(() => {
	console.log("user_39 inoperante!");
	return;
});
user_40.login("TOKEN AQUI").catch(() => {
	console.log("user_40 inoperante!");
	return;
});
user_41.login("TOKEN AQUI").catch(() => {
	console.log("user_41 inoperante!");
	return;
});
user_42.login("TOKEN AQUI").catch(() => {
	console.log("user_42 inoperante!");
	return;
});
user_43.login("TOKEN AQUI").catch(() => {
	console.log("user_43 inoperante!");
	return;
});
user_44.login("TOKEN AQUI").catch(() => {
	console.log("user_44 inoperante!");
	return;
});
user_45.login("TOKEN AQUI").catch(() => {
	console.log("user_45 inoperante!");
	return;
});
user_46.login("TOKEN AQUI").catch(() => {
	console.log("user_46 inoperante!");
	return;
});
user_47.login("TOKEN AQUI").catch(() => {
	console.log("user_47 inoperante!");
	return;
});
user_48.login("TOKEN AQUI").catch(() => {
	console.log("user_48 inoperante!");
	return;
});
user_49.login("TOKEN AQUI").catch(() => {
	console.log("user_49 inoperante!");
	return;
});
user_50.login("TOKEN AQUI").catch(() => {
	console.log("user_50 inoperante!");
	return;
});
user_51.login("TOKEN AQUI").catch(() => {
	console.log("user_51 inoperante!");
	return;
});
user_52.login("TOKEN AQUI").catch(() => {
	console.log("user_52 inoperante!");
	return;
});
user_53.login("TOKEN AQUI").catch(() => {
	console.log("user_53 inoperante!");
	return;
});
user_54.login("TOKEN AQUI").catch(() => {
	console.log("user_54 inoperante!");
	return;
});
user_55.login("TOKEN AQUI").catch(() => {
	console.log("user_56 inoperante!");
	return;
});
user_56.login("TOKEN AQUI").catch(() => {
	console.log("user_56 inoperante!");
	return;
});
user_57.login("TOKEN AQUI").catch(() => {
	console.log("user_57 inoperante!");
	return;
});
user_58.login("TOKEN AQUI").catch(() => {
	console.log("user_58 inoperante!");
	return;
});
user_59.login("TOKEN AQUI").catch(() => {
	console.log("user_59 inoperante!");
	return;
});
user_60.login("TOKEN AQUI").catch(() => {
	console.log("user_60 inoperante!");
	return;
});
user_61.login("TOKEN AQUI").catch(() => {
	console.log("user_61 inoperante!");
	return;
});
user_62.login("TOKEN AQUI").catch(() => {
	console.log("user_62 inoperante!");
	return;
});
user_63.login("TOKEN AQUI").catch(() => {
	console.log("user_63 inoperante!");
	return;
});
user_64.login("TOKEN AQUI").catch(() => {
	console.log("user_64 inoperante!");
	return;
});
user_65.login("TOKEN AQUI").catch(() => {
	console.log("user_65 inoperante!");
	return;
});
user_66.login("TOKEN AQUI").catch(() => {
	console.log("user_66 inoperante!");
	return;
});
user_67.login("TOKEN AQUI").catch(() => {
	console.log("user_67 inoperante!");
	return;
});
user_68.login("TOKEN AQUI").catch(() => {
	console.log("user_68 inoperante!");
	return;
});
user_69.login("TOKEN AQUI").catch(() => {
	console.log("user_69 inoperante!");
	return;
});
user_70.login("TOKEN AQUI").catch(() => {
	console.log("user_70 inoperante!");
	return;
});
user_71.login("TOKEN AQUI").catch(() => {
	console.log("user_71 inoperante!");
	return;
});
user_72.login("TOKEN AQUI").catch(() => {
	console.log("user_72 inoperante!");
	return;
});
user_73.login("TOKEN AQUI").catch(() => {
	console.log("user_73 inoperante!");
	return;
});
user_74.login("TOKEN AQUI").catch(() => {
	console.log("user_74 inoperante!");
	return;
});
user_75.login("TOKEN AQUI").catch(() => {
	console.log("user_75 inoperante!");
	return;
});
user_76.login("TOKEN AQUI").catch(() => {
	console.log("user_76 inoperante!");
	return;
});
user_77.login("TOKEN AQUI").catch(() => {
	console.log("user_77 inoperante!");
	return;
});
user_78.login("TOKEN AQUI").catch(() => {
	console.log("user_78 inoperante!");
	return;
});
user_79.login("TOKEN AQUI").catch(() => {
	console.log("user_79 inoperante!");
	return;
});
user_80.login("TOKEN AQUI").catch(() => {
	console.log("user_80 inoperante!");
	return;
});
user_81.login("TOKEN AQUI").catch(() => {
	console.log("user_81 inoperante!");
	return;
});
user_82.login("TOKEN AQUI").catch(() => {
	console.log("user_82 inoperante!");
	return;
});
user_83.login("TOKEN AQUI").catch(() => {
	console.log("user_83 inoperante!");
	return;
});
user_84.login("TOKEN AQUI").catch(() => {
	console.log("user_84 inoperante!");
	return;
});
user_85.login("TOKEN AQUI").catch(() => {
	console.log("user_85 inoperante!");
	return;
});
user_86.login("TOKEN AQUI").catch(() => {
	console.log("user_86 inoperante!");
	return;
});
user_87.login("TOKEN AQUI").catch(() => {
	console.log("user_87 inoperante!");
	return;
});
user_88.login("TOKEN AQUI").catch(() => {
	console.log("user_88 inoperante!");
	return;
});
user_89.login("").catch(() => {
	console.log("user_89 inoperante!");
	return;
});
user_90.login("TOKEN AQUI").catch(() => {
	console.log("user_90 inoperante!");
	return;
});
user_91.login("TOKEN AQUI").catch(() => {
	console.log("user_91 inoperante!");
	return;
});
user_92.login("TOKEN AQUI").catch(() => {
	console.log("user_92 inoperante!");
	return;
});
user_93.login("").catch(() => {
	console.log("user_93 inoperante!");
	return;
});
user_94.login("TOKEN AQUI").catch(() => {
	console.log("user_94 inoperante!");
	return;
});
user_95.login("TOKEN AQUI").catch(() => {
	console.log("user_95 inoperante!");
	return;
});
user_96.login("TOKEN AQUI").catch(() => {
	console.log("user_96 inoperante!");
	return;
});
user_97.login("TOKEN AQUI").catch(() => {
	console.log("user_97 inoperante!");
	return;
});
user_98.login("TOKEN AQUI").catch(() => {
	console.log("user_98 inoperante!");
	return;
});
user_99.login("TOKEN AQUI").catch(() => {
	console.log("user_99 inoperante!");
	return;
});
user_100.login("TOKEN AQUI").catch(() => {
	console.log("user_100 inoperante!");
	return;
});